...
def check_entity_collisions(player: Entity, creatures: list[Creature]):
    ...
    for creature in creatures:
        if player.rect.colliderect(creature.rect):
            ...
            # done! COMMENTED THIS OUT UNTIL CREATURE MOVEMENT MATCHES THE PLAYER'S APPROACH WITH ACCELERATION AND THRUST (Changelog task)
            # done! Right now the creatures have instant velocity which makes this realistic collision approach not work well...
